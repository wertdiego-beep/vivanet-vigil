// Función serverless de Vercel: /api/operador-asignar-tecnico
// Permite a la cuenta central asignar un técnico a una visita (cita) agendada
// por un cliente. Usa la cuenta de servicio para escribir en Firestore vía
// REST, sin depender de las reglas de seguridad del cliente.
...
export default async function handler(req, res) {
  ...
  const { idToken, clienteUid, citaId, tecnicoUid } = req.body || {};
  if (!idToken || !clienteUid || !citaId || !tecnicoUid) {
  ...
  try {
    ...
    console.error('Error en asignación de técnico:', err);
